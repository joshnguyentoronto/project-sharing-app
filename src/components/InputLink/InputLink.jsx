    ...
    return(
        <div id="input-link-each">
            <div className="input-link-each-name">
                ...
                <input id='input-link-each-input1' onChange={props.handleInputLinkNameChange} name={props.link.index} type="text" required value={props.link.name} />
            </div>
            <div className="input-link-each-url">
                <p id="link-url-id">Link URL:</p>
                <input id='input-link-each-input2' onChange={props.handleInputLinkUrlChange} name={props.link.index} type="text" required value={props.link.url} />
            </div>
